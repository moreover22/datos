# import sys
# get_ipython().getoutput("{sys.executable} -m pip install -U pandas-profiling[notebook]")
# get_ipython().getoutput("jupyter nbextension enable --py widgetsnbextension")
# get_ipython().getoutput("pip uninstall pandas-profiling")
get_ipython().getoutput("pip install pandas-profiling==2.7.1")
